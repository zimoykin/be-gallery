...
export class EquipmentController {
    ...
    async getEquipment(
        ...
        return this.equipmentService.findEquipmentProfileById(profile.profileId)
            .then((data) => {
    ...
    async updateEquipment(
        ...
        return this.equipmentService.updateEquipment(profile.profileId, id, dto)
            .then((data) => {
    ...
    async appendEquipment(
        ...
        return this.equipmentService.appendEquipment(profile.profileId, dto)
            .then((data) => {
                return plainToInstance(EquipmentOutputDto, data);
            }).catch((error) => {
                this.logger.error(error);
    ...
    async updateProfilePhoto(
        ...
        return this.equipmentService.removeEquipment(id, profile.profileId)
            .then((data) => {
                return plainToInstance(EquipmentOutputDto, data);
            }).catch((error) => {
                this.logger.error(error);
