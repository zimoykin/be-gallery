...
import { IEquipment } from '../profiles/interfaces/eqiupment.interface';
...
export class EquipmentService {
    ...
    constructor(
        // @ts-ignore //
        @InjectRepository(Equipment.name) private readonly equipRepository: DynamoDbRepository<Equipment>,
    ) { }
